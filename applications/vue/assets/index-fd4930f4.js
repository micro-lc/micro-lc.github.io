...
helper.default = renderWithQiankun;
helper.qiankunWindow = qiankunWindow;
var renderWithQiankun_1 = helper.renderWithQiankun = renderWithQiankun;
...
const _withScopeId$1 = (n) => (pushScopeId("data-v-a47c673d"), n = n(), popScopeId(), n);
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$8, [
        createBaseVNode("h1", _hoisted_2$8, toDisplayString(_ctx.msg), 1),
        _hoisted_3$6
      ]);
    };
  }
});
const HelloWorld_vue_vue_type_style_index_0_scoped_a47c673d_lang = "";
...
const getBasePath = () => {
  ...
  const { pathname: parcelBase } = new URL(
    ((_a = document.querySelector("qiankun-head base")) == null ? void 0 : _a.getAttribute("href")) ?? document.baseURI,
    window.document.baseURI
  );
  const documentBase = ((_b = document.querySelector("base")) == null ? void 0 : _b.getAttribute("href")) ?? void 0;
  console.log(parcelBase, documentBase);
  return {
    documentBase,
    parcelBase: documentBase === void 0 ? parcelBase : parcelBase.replace(documentBase, "/")
  };
};
const _withScopeId = (n) => (pushScopeId("data-v-8f45499f"), n = n(), popScopeId(), n);
        ...
        createBaseVNode("header", null, [
          ...
          createBaseVNode("div", _hoisted_2$7, [
            ...
            createBaseVNode("nav", null, [
              createVNode(unref(RouterLink), { to: basePath.value }, {
                default: withCtx(() => [
...
const App_vue_vue_type_style_index_0_scoped_8f45499f_lang = "";
const App = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-8f45499f"]]);
const scriptRel = "modulepreload";
const assetsURL = function(dep) {
  return "/applications/vue/" + dep;
};
const seen = {};
...
const WelcomeItem = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$5], ["__scopeId", "data-v-d5ce134a"]]);
const _sfc_main$6 = {};
const _hoisted_1$5 = {
...
const createVueRouter = () => {
  ...
  const history2 = createWebHistory(paths.documentBase);
  console.log({ paths });
  const router = createRouter({
    ...
    routes: [
      ...
      },
      {
        ...
        component: () => __vitePreload(() => import("./AboutView-14fee354.js"), true ? ["assets/AboutView-14fee354.js","assets/AboutView-ea554600.css"] : void 0),
        name: "about",
...
renderWithQiankun_1({
  ...
  unmount() {
    routerCtx == null ? void 0 : routerCtx.cleanup();
